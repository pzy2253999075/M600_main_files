...
private:
	...
	std::atomic<bool>  setMulti;
	std::atomic<bool>  setFoucus;

	boost::mutex setMultiLock;
	boost::mutex setFoucusLock;
	...
	void initSubPub(ros::NodeHandle &nh){
		gimCtrSub = nh.subscribe("m600_gimCtr",1,&GimbalCtr::gimCtrCallBack,this);
	}
...
public:
	...
	GimbalCtr(ros::NodeHandle &nh){setMulti = true;setFoucus=true;initMySerial();initSubPub(nh);}
